...
export function cleanBody(body) {
  ...
  let regexList = [
    ...
    /могу|взять|(не)?больш(ой|ие|ые)|посылк\S*|сумк\S*|туда|(о|а)братно/gi,
    ...
    /\sкто\s|(кто)?\-?\s*нибудь|мож(е|и)т|ближ\S*|врем\S*|увeз\S*|п(о|а)пут\S*|есть|мест\S*/gi,
    ...
    /\sс\s|\sв\s|\sво\s|\sдо\s|\sиз\s|\sи\s|\sили\s|\sпо\s|\sна\s|\sза\s/gi,
  ];
